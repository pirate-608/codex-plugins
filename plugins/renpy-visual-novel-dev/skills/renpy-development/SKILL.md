...
## Workflow
   ...
   - The MCP binds to the active Codex workspace and discovers a project-local
...
7. Verification:
   ...
   - Prefer MCP verification when available: `get_lint_report`,
     `find_invalid_jumps`, `find_missing_assets`, and `get_scaffold_status`.
...
- After installing or updating this plugin, start a new Codex task before
