...
- Assessment timing/status: `zju_list_assessments`.
- Questionnaire timing/status: `zju_list_questionnaires`.
- Roll-call timing/status and official page: `zju_list_rollcall_notices`.
- Discussion listing: `zju_list_discussions`.
- One selected thread: `zju_get_discussion`.
