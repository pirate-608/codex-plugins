...
- Run `ae_validateExpressions`, then preview representative frames; valid syntax may still produce wrong motion.
...
Parameter readback proves structure, not design quality. Use `ae_previewFrame` for comp pixels and state which times were inspected.
