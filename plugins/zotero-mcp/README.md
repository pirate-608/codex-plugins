...
This Codex plugin connects to a running Zotero 7 desktop application through
...
```text
Add git@github.com:pirate-608/codex-plugins.git as a Codex plugin marketplace, install zotero-mcp,
